...
public void tearDown() {
    extent.flush();
		...
		public void testPostpassword(String url) 
		{
			...
			Response response=UserEndPoints2.Createuserchangepassword(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		...
		public void testresetpassword(String url)
		{
			...
			Response response=UserEndPoints2.Createresetpassword(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		...
		public void testUpdatepassword(String url)
		{
			...
			Response response=UserEndPoints2.CreateUpdatepassword(url);
			//response.then().log().body().statusCode(200);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testadd_security_pulserecord(String url)
		{
			...
			Response response=UserEndPoints2.Createaddsecuritypulserecord(url);
			response.then().log().all();
		Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		@Test(dataProvider="empdateprovider")
		void testUpdatePassword(String url) 
		{
			test = extent.createTest("testUpdatePassword");	
			Response response=UserEndPoints2.CreateUpdatepassword(url); 
		    response.then().log().all(); 
	    ...
	    public void testpredefinedfunction(String url)
		{
			...
			Response response=UserEndPoints2.Createpredefinedfunction(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		 ...
		 public void testentity_creation(String url)
		{
			...
			Response response=UserEndPoints2.Createentity_creation(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testentity_function_process(String url)
		{
			...
			Response response=UserEndPoints2.Createentity_function_process(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testget_entity_assets(String url)
		{
			...
			Response response=UserEndPoints2.Createget_entity_assets(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testasset_risk(String url)
		{
			...
			Response response=UserEndPoints2.Createasset_risk(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testprocess_risk(String url)
		{
			...
			Response response=UserEndPoints2.Createprocess_risk(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testfunction_risk(String url)
		{
			...
			Response response=UserEndPoints2.Createfunction_risk(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testgeo_risk1(String url)
		{
			...
			Response response=UserEndPoints2.Creategeo_risk(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testget_all_dashboard_risk_data(String url)
		{
			...
			Response response=UserEndPoints2.Createget_all_dashboard_risk_data(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testAllAssets_avg_risk_details(String url)
		{
			...
			Response response=UserEndPoints2.CreateAllAssets_avg_risk_details(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testuploaded_data_status(String url)
		{
			...
			Response response=UserEndPoints2.Createuploaded_data_status(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
	     ...
	     public void testfetch_risk_journey(String url)
		{
			...
			Response response=UserEndPoints2.Createfetch_risk_journey(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testupdate_risk_journey(String url)
		{
			...
			Response response=UserEndPoints2.Createupdate_risk_journey(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testreset_mfa_status(String url)
		{
			...
			Response response=UserEndPoints2.Createreset_mfa_status(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testsource(String url)
		{
			...
			Response response=UserEndPoints2.Createsource(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testwrapper(String url)
		{
			...
			Response response=UserEndPoints2.Createwrapper(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		 ...
		 public void testUser_Data(String url)
		{
			...
			Response response=UserEndPoints2.CreateUser_Data(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
	  ...
	  public void testtenant_list(String url)
		{
			...
			Response response=UserEndPoints2.Createtenant_list(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testSend_Mail(String url)
		{
			...
			Response response=UserEndPoints2.CreateSend_Mail(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testuser_enable_disable(String url)
		{
			...
			Response response=UserEndPoints2.Createuser_enable_disable(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testmfa_reset_Admin(String url)
		{
			...
			Response response=UserEndPoints2.Createmfa_reset_Admin(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testpackages_list(String url)
		{
			...
			Response response=UserEndPoints2.Createpackages_list(url);
			response.then().log().all();
		...
		public void testpredefined_category_type(String url)
		{
			...
			Response response=UserEndPoints2.Createpredefined_category_type(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testget_tags(String url)
		{
			...
			Response response=UserEndPoints2.Createget_tags(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testtenant_matrix(String url)
		{
			...
			Response response=UserEndPoints2.Createtenant_matrix(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
//		
		...
		public void testuser_matrix(String url)
		{
			...
			Response response=UserEndPoints2.Createuser_matrix (url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testsecurity_pulse_Data(String url)
		{
			...
			Response response=UserEndPoints2.Createsecurity_pulse_Data(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testsecurity_pulse_grid_data(String url)
		{
			...
			Response response=UserEndPoints2.Createsecurity_pulse_grid_data(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testAdd_predefined_data(String url)
		{
			...
			Response response=UserEndPoints2.CreateAdd_predefined_data(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testmaster_function_process(String url)
		{
			...
			Response response=UserEndPoints2.Createmaster_function_process(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testmaster_function_update(String url)
		{
			...
			Response response=UserEndPoints2.Createmaster_function_update(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testmaster_function_delect(String url)
		{
			...
			Response response=UserEndPoints2.Createmaster_function_delect(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testmaster_process_update(String url)
		{
			...
			Response response=UserEndPoints2.Createmaster_process_update(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testget_predefined_data(String url)
		{
			...
			Response response=UserEndPoints2.Createget_predefined_data(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testadd_new_predefined_function(String url)
		{
			...
			Response response=UserEndPoints2.Createadd_new_predefined_function(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testfetch_new_predefined_function(String url)
		{
			...
			Response response=UserEndPoints2.Createfetch_new_predefined_function(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testcreate_predefined_process(String url)
		{
			...
			Response response=UserEndPoints2.Createcreate_predefined_process(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testepoch_time_convert(String url)
		{
			...
			Response response=UserEndPoints2.Createepoch_time_convert(url);
			response.then().log().all();
		...
		public void testcsv_template_download(String url)
		{
			...
			Response response=UserEndPoints2.Createcsv_template_download(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testAdd_source_data_siem(String url)
		{
			...
			Response response=UserEndPoints2.CreateAdd_source_data_siem(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testuser_enable_and_disable(String url)
		{
			...
			Response response=UserEndPoints2.Createuser_enable_and_disable(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testget_entity_with_location(String url)
		{
			...
			Response response=UserEndPoints2.Createget_entity_with_location(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testget_schema_language(String url)
		{
			...
			Response response=UserEndPoints2.Createget_schema_language(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testlayout_update(String url)
		{
			...
			Response response=UserEndPoints2.Createlayout_update(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testlayout_fetch(String url)
		{
			...
			Response response=UserEndPoints2.Createlayout_fetch(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testget_rgu(String url)
		{
			...
			Response response=UserEndPoints2.Createget_rgu(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testasset_risk_change(String url)
		{
			...
			Response response=UserEndPoints2.Createasset_risk_change(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testtotal_investment_chart(String url)
		{
			...
			Response response=UserEndPoints2.Createtotal_investment_chart(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testget_location_data(String url)
		{
			...
			Response response=UserEndPoints2.Createget_location_data(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testget_asset_type_summary(String url)
		{
			...
			Response response=UserEndPoints2.Createget_asset_type_summary(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testseceon_services_list(String url)
		{
			...
			Response response=UserEndPoints2.Createseceon_services_list(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testupdate_risk_journey1(String url)
		{
			...
			Response response=UserEndPoints2.Createupdate_risk_journey1(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testadd_security_pulse_record(String url)
		{
			...
			Response response=UserEndPoints2.Createadd_security_pulse_record(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testentity_assets(String url)
		{
			...
			Response response=UserEndPoints2.Createentity_assets(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testmfa_status_reset(String url)
		{
			...
			Response response=UserEndPoints2.Createmfa_status_reset(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testwrapper1(String url)
		{
			...
			Response response=UserEndPoints2.Createwrapper1(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testSend_mail1(String url)
		{
			...
			Response response=UserEndPoints2.CreateSend_mail1(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testuser_matrix1(String url)
		{
			...
			Response response=UserEndPoints2.Createuser_matrix1(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testsecurity_pulse_data1(String url)
		{
			...
			Response response=UserEndPoints2.Createsecurity_pulse_data1(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testget_asset_type_summary1(String url)
		{
			...
			Response response=UserEndPoints2.Createget_asset_type_summary1(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testAdmin_reset_password(String url)
		{
			...
			Response response=UserEndPoints2.CreateAdmin_reset_password(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testUpdate_User_language(String url)
		{
			...
			Response response=UserEndPoints2.CreateUpdate_User_language(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testoei_page_data_new(String url)
		{
			...
			Response response=UserEndPoints2.Createoei_page_data_new(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testget_advisory_data(String url)
		{
			...
			Response response=UserEndPoints2.Createget_advisory_data(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		...
		public void testupdate_asset_type_summary(String url)
		{
			...
			Response response=UserEndPoints2.Createupdate_asset_type_summary(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testvulnerabilities_grid_view(String url)
		{
			...
			Response response=UserEndPoints2.Createvulnerabilities_grid_view(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testvulnerabilities_master_grid_view(String url)
		{
			...
			Response response=UserEndPoints2.Createvulnerabilities_master_grid_view(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testchange_tenant_package(String url)
		{
			...
			Response response=UserEndPoints2.Createchange_tenant_package(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),403);
		}
		@Test(dataProvider="empdateprovider")
		public void testcchange_customer_data(String url)
		{
			...
			Response response=UserEndPoints2.Createchange_customer_data(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),403);
		}
		@Test(dataProvider="empdateprovider")
		public void testtenant_list1(String url)
		{
			...
			Response response=UserEndPoints2.Createtenant_list1(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
//		//@Test(dataProvider="empdateprovider")
...
//			Response response=UserEndPoints2.Createpackages_list1(url);
//			response.then().log().all();
//			Assert.assertEquals(response.getStatusCode(),200);
//		}
		@Test(dataProvider="empdateprovider")
		public void testadd_security_pulse_data(String url)
		{
			...
			Response response=UserEndPoints2.Createadd_security_pulse_data(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
//		@Test(dataProvider="empdateprovider")
...
//		}
		...
		public void testpreference_input(String url)
		{
			...
			Response response=UserEndPoints2.Createpreference_input(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testpreference_fetch(String url)
		{
			...
			Response response=UserEndPoints2.Createpreference_fetch(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testtheme_preference_update(String url)
		{
			...
			Response response=UserEndPoints2.Createtheme_preference_update(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testupdate_language(String url)
		{
			...
			Response response=UserEndPoints2.Createupdate_language(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testlayout(String url)
		{
			...
			Response response=UserEndPoints2.Createlayout(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testupdate_layout(String url)
		{
			...
			Response response=UserEndPoints2.Createupdate_layout(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testreset_layout(String url)
		{
			...
			Response response=UserEndPoints2.Createreset_layout(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testreset_layout_admin(String url)
		{
			...
			Response response=UserEndPoints2.Createreset_layout_admin(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),403);
		}
		@Test(dataProvider="empdateprovider")
		public void testfetch_risk_pages(String url)
		{
			...
			Response response=UserEndPoints2.Createfetch_risk_pages(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
	}
		@Test(dataProvider="empdateprovider")
		public void testfetch_risk_questions(String url)
		{
			...
			Response response=UserEndPoints2.Createfetch_risk_questions(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testadd_update_risk_question(String url)
		{
			...
			Response response=UserEndPoints2.Createadd_update_risk_question(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testdelete_risk_question(String url)
		{
			...
			Response response=UserEndPoints2.Createdelete_risk_question(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testfaq(String url)
		{
			...
			Response response=UserEndPoints2.Createfaq(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testview_email_data(String url)
		{
			...
			Response response=UserEndPoints2.Createview_email_data(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testcreate_update_email_data(String url)
		{
			...
			Response response=UserEndPoints2.Createcreate_update_email_data(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testdelete_email_data(String url)
		{
			...
			Response response=UserEndPoints2.Createdelete_email_data(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testreactive_email_data(String url)
		{
			...
			Response response=UserEndPoints2.Createreactive_email_data(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testrcontact_us(String url)
		{
			...
			Response response=UserEndPoints2.Createcontact_us(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testadd_source(String url)
		{
			...
			Response response=UserEndPoints2.Createadd_source(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testtenant_lang(String url)
		{
			...
			Response response=UserEndPoints2.Createtenant_lang(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testentity_predefined_function(String url)
		{
			...
			Response response=UserEndPoints2.Createentity_predefined_function(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testget_predefined_category(String url)
		{
			...
			Response response=UserEndPoints2.Createget_predefined_category(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testget_predefined_type(String url)
		{
			...
			Response response=UserEndPoints2.Createget_predefined_type(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testcreate_predefined_function(String url)
		{
			...
			Response response=UserEndPoints2.Createcreate_predefined_function(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testdelete_predefined_function(String url)
		{
			...
			Response response=UserEndPoints2.Createdelete_predefined_function(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testtenant_data_status(String url)
		{
			...
			Response response=UserEndPoints2.Createtenant_data_status(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testfetch_predefined_data(String url)
		{
			...
			Response response=UserEndPoints2.Createfetch_predefined_data(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testadd_tenant(String url)
		{
			...
			Response response=UserEndPoints2.Createadd_tenant(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),403);
		}
//		//@Test(dataProvider="empdateprovider")
...
//			Response response=UserEndPoints2.Createpackages(url);
//			response.then().log().all();
//			Assert.assertEquals(response.getStatusCode(),403);
//		}
		@Test(dataProvider="empdateprovider")
		public void testsecurity_pulse_details_data(String url)
		{
			...
			Response response=UserEndPoints2.Createsecurity_pulse_details_data(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testfetch_predefined_category(String url)
		{
			...
			Response response=UserEndPoints2.Createfetch_predefined_category(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testcreate_category(String url)
		{
			...
			Response response=UserEndPoints2.Createcreate_category(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testcreate_subcategory(String url)
		{
			...
			Response response=UserEndPoints2.Createcreate_subcategory(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testdelete_category(String url)
		{
			...
			Response response=UserEndPoints2.Createdelete_category(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testdelete_subcategory(String url)
		{
			...
			Response response=UserEndPoints2.Createdelete_subcategory(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testfetch_predefined_type(String url)
		{
			...
			Response response=UserEndPoints2.Createfetch_predefined_type(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testcreate_subtype(String url)
		{
			...
			Response response=UserEndPoints2.Createcreate_subtype(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testcdelete_subtype(String url)
		{
			...
			Response response=UserEndPoints2.Createdelete_subtype(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testcreate_tag(String url)
		{
			...
			Response response=UserEndPoints2.Createcreate_tag(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testdelete_tag(String url)
		{
			...
			Response response=UserEndPoints2.Createdelete_tag(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testget_tmf_data(String url)
		{
			...
			Response response=UserEndPoints2.Createget_tmf_data(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testdelete_tmf_factor(String url)
		{
			...
			Response response=UserEndPoints2.Createdelete_tmf_factor(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testget_usecase(String url)
		{
			...
			Response response=UserEndPoints2.Createget_usecase(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testadd_usecase(String url)
		{
			...
			Response response=UserEndPoints2.Createadd_usecase(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testdelete_usecase(String url)
		{
			...
			Response response=UserEndPoints2.Createdelete_usecase(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testadd_rule(String url)
		{
			...
			Response response=UserEndPoints2.Createadd_rule(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testdelete_rule(String url)
		{
			...
			Response response=UserEndPoints2.Createdelete_rule(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testget_feeds(String url)
		{
			...
			Response response=UserEndPoints2.Createget_feeds(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testget_advisory(String url)
		{
			...
			Response response=UserEndPoints2.Createget_advisory(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testadd_predefined_function(String url)
		{
			...
			Response response=UserEndPoints2.Createadd_predefined_function();
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testUser_Create(String url)
		{
			...
			Response response=UserEndPoints2.CreateUser_Create(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testfetchrisk_journey(String url)
		{
			...
			Response response=UserEndPoints2.Createfetchrisk_journey(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testdeletepredefined_function(String url)
		{
			...
			Response response=UserEndPoints2.Createdeletepredefined_function(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testget_risk_aggregation(String url)
		{
			...
			Response response=UserEndPoints2.Createget_risk_aggregation(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testget_risk_aggr_bar_chart_data(String url)
		{
			...
			Response response=UserEndPoints2.Createget_risk_aggr_bar_chart_data(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testrisk_screen_details_data(String url)
		{
			...
			Response response=UserEndPoints2.Createrisk_screen_details_data(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testupdate_risk_configuration(String url)
		{
			...
			Response response=UserEndPoints2.Createupdate_risk_configuration(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testrisk_screen_details(String url)
		{
			...
			Response response=UserEndPoints2.Createrisk_screen_details(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testcreate_update_entity(String url)
		{
			...
			Response response=UserEndPoints2.Createcreate_update_entity(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testget_entity(String url)
		{
			...
			Response response=UserEndPoints2.Createget_entity(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testadd_custom_function(String url)
		{
			...
			Response response=UserEndPoints2.Createadd_custom_function(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testdelete_custom_process(String url)
		{
			...
			Response response=UserEndPoints2.Createdelete_custom_process(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testcreate_entity_function_proces(String url)
		{
			...
			Response response=UserEndPoints2.create_entity_function_process(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testcreate_entity_assets(String url)
		{
			...
			Response response=UserEndPoints2.create_entity_assets(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testCreatedelete_asset(String url)
		{
			...
			Response response=UserEndPoints2.Createdelete_asset(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testupdate_entity_status(String url)
		{
			...
			Response response=UserEndPoints2.Createupdate_entity_status(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testget_pdf(String url)
		{
			...
			Response response=UserEndPoints2.Createget_pdf(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testget_pdf_data(String url)
		{
			...
			Response response=UserEndPoints2.Createget_pdf_data(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testget_excel_template(String url)
		{
			...
			Response response=UserEndPoints2.Createget_excel_template(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testmaster_filters(String url)
		{
			...
			Response response=UserEndPoints2.Createmaster_filters(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testget_function_data(String url)
		{
			...
			Response response=UserEndPoints2.Createget_function_data(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testget_process_data(String url)
		{
			...
			Response response=UserEndPoints2.Createget_process_data(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testget_heat_map_data(String url)
		{
			...
			Response response=UserEndPoints2.Createget_heat_map_data(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testupdate_vulnerability_master(String url)
		{
			...
			Response response=UserEndPoints2.Createupdate_vulnerability_master(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testmaster_vulnerability_grid(String url)
		{
			...
			Response response=UserEndPoints2.Createmaster_vulnerability_grid(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testget_asset_summary(String url)
		{
			...
			Response response=UserEndPoints2.Createget_asset_summary(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		@Test(dataProvider="empdateprovider")
		public void testadd_update_rgu_data(String url)
		{
			...
			Response response=UserEndPoints2.Createadd_update_rgu_data(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testdelete_rgu_data(String url)
		{
			...
			Response response=UserEndPoints2.Createdelete_rgu_data(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
...
//			Response response=UserEndPoints2.Createadd_predefined_type(url);
//			response.then().log().all();
//			Assert.assertEquals(response.getStatusCode(),200);
//		}
		...
		public void testadd_package(String url)
		{
			...
			Response response=UserEndPoints2.Createadd_package(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),403);
		}
		...
		public void testsecurity_pulse_record_delete(String url)
		{
			...
			Response response=UserEndPoints2.Createsecurity_pulse_record_delete(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testadd_update_tmf_factor(String url)
		{
			...
			Response response=UserEndPoints2.Createadd_update_tmf_factor(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testadvisory_pdf(String url)
		{
			...
			Response response=UserEndPoints2.Createadvisory_pdf(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),200);
		}
		...
		public void testupdate_customer(String url)
		{
			...
			Response response=UserEndPoints2.Createupdate_customer(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),403);
		}
		...
		public void testchange_customer_package(String url)
		{
			...
			Response response=UserEndPoints2.Createchange_customer_package(url);
			response.then().log().all();
			Assert.assertEquals(response.getStatusCode(),403);
		}
...
//		        String UrlExel[] = new String[rownum];
//		        for (int i = 1; i <= rownum; i++) {
//		            UrlExel[i - 1] = XLUtils.getCellData(path, "Sheet1", i, 0);
//		        }
//		        return UrlExel;
//		    } catch (IOException e) {
//		        e.printStackTrace();
