...
public class UserEndPoints3 {
    ...
    public static Response Createuserchangepassword(String url) 
     {
		String Access_Token2 = LoginAPI.Createlogin2();
 ...
 //Part--3
	...
	{
		String Access_Token = LoginAPI.Createlogin2();
        Response response = given()
