...
public class UserEndPoints2 {
    ...
    public static Response Createuserchangepassword(String url) 
     {
		String Access_Token1 = LoginAPI.Createlogin1();
 ...
 //Part--3
 	...
 	public static Response Createadd_tenant(String url)
 	{
 		...
 		.body("{\r\n"
 				+ "    \"schema_name\": \"exotel\",\r\n"
 				+ "    \"name\": \"exotel\",\r\n"
 				+ "    \"domain\": \"abhitangale@gmail.com\",\r\n"
 				+ "    \"package\": \"abhitangale@gmail.com\"\r\n"
 				+ "}")
 		.when()
 		.post(Routes2.post109_url);
	...
	{
		String Access_Token = LoginAPI.Createlogin1();
        Response response = given()
